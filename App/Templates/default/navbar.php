    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a class="navbar-brand mt-2 mt-lg-0" href="#">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Wiki-black.png/842px-Wiki-black.png"
                     height="50"/>
            </a>
            <!-- Left links -->
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (!empty($_SESSION['user'])): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/article/create">Écrire un article</a>
                    </li>
                <?php endif; ?>
            </ul>
            <!-- Left links -->
            ...
            <?php else: ?>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                        ...
                        <li>
                            <a class="dropdown-item" href="/logout" data-mdb-ripple-init data-mdb-modal-init
                               data-mdb-target="#confirmLogoutModal">Se déconnecter</a>
                        </li>
                    </ul>
                </div>
            <?php endif; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" data-mdb-ripple-init id="confirmLogoutBtn">Confirmer
                </button>
            </div>
        </div>
    </div>
