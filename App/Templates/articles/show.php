                ...
                <div class="card-body p-4">
                    <div class="form-outline mb-4">
                        <form method="POST" action="/commentaire/addComment/<?=$articleId?>" id='addCommentForm'>
                            <input type="text" id="addComment" name="addComment" class="form-control" placeholder="Type comment..." />
                            <label class="form-label" for="addANote">+ Ajouter un commentaire</label>
                            <button type="submit" class="btn btn-success mt-4" data-mdb-ripple-init>Confirmer</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <div class="d-flex flex-start">
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <p class="mb-0"><?= $comment['createdAt'] ?> <span class="badge bg-success">Validé</span>
                                    </p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" data-mdb-ripple-init id="confirmCommentDeleteBtn">Confirmer
                </button>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#versionSelect').on('change', function() {
            var selectedVersion = versions.find(function(version) {return version.id == $(this).val()});
